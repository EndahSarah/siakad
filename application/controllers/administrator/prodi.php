...
class Prodi extends CI_Controller
{
    ...
    public function tambah_prodi_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            role="alert">Data Prodi Berhasil Update!
...

    {
        ...
        $this->session->set_flashdata(
            'pesan',
            '<div class="alert alert-success alert-dismissible fade-show"
            role="alert">Data Prodi Berhasil DiUpdate!
            <button type="button" class="close"
            data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
    ...
    {
        $where = array('id_prodi' => $id);
        $this->jurusan_model->hapus_data($where, 'prodi');
        $this->session->set_flashdata(
            'pesan',
            '<div class="alert alert-danger alert-dismissible fade-show"
        role="alert">Data Prodi Berhasil Dihapus!
        <button type="button" class="close"
        data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
