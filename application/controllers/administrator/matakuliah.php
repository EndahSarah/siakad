...
class Matakuliah extends CI_Controller
{
    ...
    public function tambah_matakuliah_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            role="alert">Data Mata Kuliah Berhasil Ditambahkan!
    ...
    public function update_aksi()
    {
        ...
        $data = array(
            'kode_matakuliah' => $kode_matakuliah,
            'namma_matakuliah' => $nama_matakuliah,
            'sks' => $sks,
            'semester' => $semester,
            'nama_prodi' => $nama_prodi
        );
        ...
        $this->session->set_flashdata(
            'pesan',
            '<div class="alert alert-success alert-dismissible fade-show"
                role="alert">Data Matakuliah Berhasil DiUpdate!
                <button type="button" class="close"
                data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
    ...
    public function delete($id)
    {
        ...
        role="alert">Data Matakuliah Berhasil Dihapus!
        <button type="button" class="close"
        data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
