<div class="container-fluid">
    <div class="container-fluid">
        ...
        <!--flash pesan kesalahan-->
        <?php echo $this->session->flashdata('pesan') ?>


        <?php echo anchor('administrator/matakuliah/tambah_matakuliah', '<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-fa-plus fa-sm"></i>Tambah Mata Kuliah</button>
') ?>

        <table class="table table-bordered tabke-hover table-striped">
            <tr>
                <th>NO</th>
